...
__decorate([
    ...
    __metadata("design:type", Number)
], bettingSlot.prototype, "providerThirdpartyId", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'transaction_id', comment: '1: bet+win 2: bet 3: win' }),
    __metadata("design:type", String)
], bettingSlot.prototype, "transationId", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'transaction_type' }),
    __metadata("design:type", String)
], bettingSlot.prototype, "transactionType", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'selected_bet', comment: '0: 정보없음, 1: 벵커, 2: 플레이어, 3: 타이' }),
    __metadata("design:type", Number)
], bettingSlot.prototype, "selectedBet", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'bet_amount', type: 'int' }),
    __metadata("design:type", Number)
], bettingSlot.prototype, "betAmount", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'result_amount', type: 'int' }),
    __metadata("design:type", Number)
], bettingSlot.prototype, "resultAmount", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'valid_amount', type: 'int' }),
    __metadata("design:type", Number)
], bettingSlot.prototype, "validAmount", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'bet_result' }),
    __metadata("design:type", String)
], bettingSlot.prototype, "betResult", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'is_calculated', type: 'tinyint', comment: '정산 여부 - 0: 미정산, 1: 정산완료, 2: 누락' }),
    __metadata("design:type", Number)
], bettingSlot.prototype, "isCalculated", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'game_name' }),
    __metadata("design:type", String)
], bettingSlot.prototype, "gameName", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'betting_at' }),
    __metadata("design:type", String)
], bettingSlot.prototype, "bettingAt", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'calculated_at' }),
    __metadata("design:type", String)
], bettingSlot.prototype, "calculatedAt", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)({ name: 'created_at' }),
    __metadata("design:type", Date)
], bettingSlot.prototype, "createdAt", void 0);
bettingSlot = __decorate([
    (0, typeorm_1.Entity)({ name: 'betting_slot' }),
    (0, typeorm_1.Unique)(['id'])
], bettingSlot);
exports.bettingSlot = bettingSlot;
//# sourceMappingURL=betting-slot.entity.js.map