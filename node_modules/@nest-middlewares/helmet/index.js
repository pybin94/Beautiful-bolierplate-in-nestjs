...
exports.HelmetXssFilterMiddleware = exports.HelmetReferrerPolicyMiddleware = exports.HelmetNoSniffMiddleware = exports.HelmetNoCacheMiddleware = exports.HelmetIeNoOpenMiddleware = exports.HelmetHstsMiddleware = exports.HelmetHpkpMiddleware = exports.HelmetHidePoweredByMiddleware = exports.HelmetFrameguardMiddleware = exports.HelmetExpectCtMiddleware = exports.HelmetDnsPrefetchControlMiddleware = exports.HelmetContentSecurityPolicyMiddleware = exports.HelmetMiddleware = void 0;
...
let HelmetMiddleware = HelmetMiddleware_1 = class HelmetMiddleware {
    ...
    use(req, res, next) {
        if (HelmetMiddleware_1.options) {
            (0, helmet_1.default)(HelmetMiddleware_1.options)(req, res, next);
        }
        else {
